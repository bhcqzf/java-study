 ...
 * </p>
 * <p>
 * Copyright: Mixky co., ltd. Copyright (c) 2005
 * </p>
 * <p>
...
public class EncryptArithmetic {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
         ...
         *  }
         * " --> " + EncryptArithmetic.e(args[0])); } catch (Exception e) {
         * e.printStackTrace(); }
         */
        EncryptArithmetic ea = new EncryptArithmetic();
        String str = "1mixky-cms-8encrypt-5key";
        String f_password = ea.encryptIt("1234", str.getBytes("ISO-8859-1"));
